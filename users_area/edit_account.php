...
<body>
    <h3 class="text-center text-success mt-4 mb-4">Edit Account</h3>
    <form action="" method="post" enctype="multipart/form-data" class="text-center">
        <div class="form-outliine mb-4">
            <input value="<?php echo $username ?>" placeholder="Enter your username" type="text" name="user_username" class="form-control w-50 m-auto">
        </div>
        <div class="form-outliine mb-4">
            <input value="<?php echo $user_email ?>" placeholder="Enter your email" type="text" name="user_email" class="form-control w-50 m-auto">
        </div>
