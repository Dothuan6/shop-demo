...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline mb-4 w-50 m-auto mt-4">
            ...
            <div class="form-outline mb-4 w-50 m-auto mt-4">
            <label for="product_category" class="form-label">Product Brand</label>
        ...
        <div class="w-50 m-auto">
            <input type="submit" name="edit_product" value="Update product" class="btn btn-info mb-3 px-3 mt-4">
        </div>
    </form>
</div>
<!-- editing products -->
